<?php
/**
 * Demo site setup for Granvik Tak.
 *
...
$home = nps_page(
	...
	nps_pattern( 'granviktak/page-home' ),
...
nps_page(
	'takomlaggning',
	'Takomläggning',
	nps_pattern( 'granviktak/page-replacement' ),
...
nps_page(
	...
	nps_pattern( 'granviktak/page-storm' ),
...
$quote = nps_page(
	'offert',
	'Boka besiktning',
	nps_pattern( 'granviktak/quote-funnel' ),
...
$thanks = nps_page(
	'tack',
	'Tack',
	nps_pattern( 'granviktak/thank-you' ),
...
<p class="has-large-font-size">Granvik Tak är ett familjeföretag från Sollentuna. Vi startade 1996 med en bil och en regel vi fortfarande håller oss till: priset vi skriver ner är priset du betalar.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:list -->
HTML;
nps_page( 'om-oss', 'Om Granvik Tak', $about_content . "\n\n" . nps_pattern( 'granviktak/cta-inline' ), 'Familjeägt takföretag i norra Stockholm sedan 1996. Egna montörer, fasta priser skriftligt och 10 års garanti.' );
...
nps_page( 'vanliga-fragor', 'Vanliga frågor', $faq_content . "\n\n" . nps_pattern( 'granviktak/cta-inline' ), 'Svar om offert, pris, ROT-avdrag, hur lång tid en takomläggning tar och vad garantin täcker.' );
...
nps_log( 'Granvik Tak demo ready.' );
