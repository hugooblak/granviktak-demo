...
<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:66%"><!-- wp:group {"className":"gt-orter","layout":{"type":"flex","flexWrap":"wrap"}} -->
<div class="wp-block-group gt-orter"><?php
foreach ( $orter as $o ) :
