...
<div class="wp-block-cover alignfull gt-sec-hero" style="min-height:88vh"><span aria-hidden="true" class="wp-block-cover__background has-ink-background-color has-background-dim-40 has-background-dim"></span><img class="wp-block-cover__image-background" alt="<?php echo esc_attr( gt_lead( 'foretag' ) ); ?>" src="<?php echo esc_url( gt_lead_img( gt_lead( 'bild_hero' ) ) ); ?>" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:columns {"verticalAlignment":"bottom","align":"wide","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|60"}}}} -->
...
<p class="is-style-eyebrow has-sand-color has-text-color"><?php echo esc_html( gt_bransch( 'yrke' ) ); ?> i <?php echo esc_html( implode( ', ', array_slice( (array) gt_lead( 'orter', array() ), 0, 4 ) ) ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":1,"textColor":"base","fontSize":"display"} -->
<h1 class="wp-block-heading has-base-color has-text-color has-display-font-size"><?php echo esc_html( gt_bransch( 'rubrik' ) ); ?><br><em><?php echo esc_html( gt_bransch( 'rubrik2' ) ); ?></em></h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"sand","fontSize":"large"} -->
<p class="has-sand-color has-text-color has-large-font-size"><?php echo esc_html( gt_bransch( 'ingress' ) ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-base-color has-text-color wp-element-button" href="<?php echo esc_url( home_url( '/offert' ) ); ?>"><?php echo esc_html( gt_bransch( 'cta' ) ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<p class="has-base-color has-text-color"><strong><?php echo esc_html( gt_lead( 'antal_tak' ) ); ?></strong><br><span><?php echo esc_html( gt_bransch( 'jobb_etikett' ) ); ?></span></p>
<!-- /wp:paragraph -->
...
<h2 class="wp-block-heading has-x-large-font-size">Få ett fast pris</h2>
<!-- /wp:heading -->
