...
add_filter(
	...
	function () {
		return array(
			...
			'title'        => __( 'Name', 'granviktak-leads' ),
			'npl_phone'    => __( 'Phone', 'granviktak-leads' ),
			'npl_service'  => __( 'Needs', 'granviktak-leads' ),
			'npl_timeline' => __( 'When', 'granviktak-leads' ),
			'npl_zip'      => __( 'ZIP', 'granviktak-leads' ),
			'npl_source'   => __( 'Source', 'granviktak-leads' ),
			'npl_status'   => __( 'Status', 'granviktak-leads' ),
			'date'         => __( 'Received', 'granviktak-leads' ),
		);
	}
);
...
function npl_source_summary( $post_id ) {
	...
	return __( 'Direct', 'granviktak-leads' );
}
...
function npl_details_box( $post ) {
	$rows = array(
		...
		__( 'Source', 'granviktak-leads' )   => npl_source_summary( $post->ID ),
	);
...
function npl_status_box( $post ) {
	...
	echo '<label class="screen-reader-text" for="npl-status">' . esc_html__( 'Status', 'granviktak-leads' ) . '</label><select id="npl-status" name="npl_status" style="width:100%">';
