 ...
 * or photo. They call gt_lead() instead. To build a demo for a real firm, the
 ...
 *
 * With no lead-data.php present the defaults below render the fictional Granvik Tak.
 *
 * @package Granvik Tak
 */
 ...
 * @return string
 */
function gt_sample_note() {
	return gt_lead( 'ar_riktig' ) ? '' : ' <span class="gt-sample">(platshållare)</span>';
}
 ...
 * @return string File name for gt_lead_img().
 */
function gt_lead_bild( $i ) {
	$bilder = (array) gt_lead( 'bilder', array() );
